...
# 安装指定版本
VERSION=v1.6.3 /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/zevwings/workflow.rs/master/scripts/install.sh)"
```
...
**安装指定版本**:
```powershell
$env:VERSION="v1.6.3"; powershell -ExecutionPolicy Bypass -Command "Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/zevwings/workflow.rs/master/scripts/install.ps1' -OutFile install.ps1; .\install.ps1"
```
...
workflow update --version 1.6.3    # 更新到指定版本
