...
> **⚠️ 同步提示**：此文件必须与其英文版本 `.cursor/rules/sync.md` 保持同步。修改此文件时，必须立即更新对应的英文版本。
...
- **修改 `.cursor/rules/{filename}.md`（英文版）** → 必须立即同步更新 `docs/cursorrules/{filename}.md`（中文版）
- **修改 `docs/cursorrules/{filename}.md`（中文版）** → 必须立即同步更新 `.cursor/rules/{filename}.md`（英文版）
