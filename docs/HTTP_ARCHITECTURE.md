...
**使用场景**：
- 所有需要 HTTP 请求的模块都使用 `HttpClient::global()`
- Jira API 调用
- GitHub/Codeup API 调用
- 网络检查
...
**核心功能**：
- HTTP 方法定义（GET、POST、PUT、DELETE、PATCH）
- 字符串转换
