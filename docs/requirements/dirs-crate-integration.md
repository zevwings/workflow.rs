...
- [ ] 步骤 2：在 `paths.rs` 添加 `home_dir()` 辅助方法
- [ ] 步骤 3：更新 `paths.rs` 中的所有方法
- [ ] 步骤 4：更新 `completion/completion.rs`
- [ ] 步骤 5：更新 `shell/config.rs`
- [ ] 步骤 6：更新 `settings/defaults.rs`
- [ ] 步骤 7：更新 `completion/generate.rs`
- [ ] 步骤 8：运行单元测试 `cargo test`
- [ ] 步骤 9：运行集成测试
- [ ] 步骤 10：在 macOS/Linux/Windows 上测试
- [ ] 步骤 11：更新文档
- [ ] 步骤 12：提交代码
