...
#### 4. 工作流文档模板 (`workflow.template`)

**工作流文档模板** (`docs/guidelines/templates/workflow.template`)
   - 适用于：主要工作流文档，如提交前检查、综合深入检查等
   - 特点：包含 Mermaid 流程图、快速导航、检查步骤、进度指示器、报告生成等
   - 示例：`pre-commit.md`、`review.md`、`README.md`（工作流索引）
   - 位置：`docs/guidelines/templates/workflow.template`
...
```bash
# 复制工作流文档模板
cp docs/guidelines/templates/workflow.template docs/guidelines/workflows/{topic}.md
...
```bash
# 复制检查指南模板
cp docs/guidelines/templates/review-guide.template docs/guidelines/workflows/references/{topic}.md
...
- **工作流文档**：参考模板结构和格式生成工作流文档，包含流程图、快速导航、检查步骤、进度指示器等
- **检查指南文档**：参考模板结构和格式生成检查指南，根据文档类型选择详细模式（检查指南）或简洁模式（快速参考）
- 如果模块只有 Lib 层或只有 Commands 层，可以省略对应部分
- 根据文档类型选择合适的模板（架构文档 vs 指南文档 vs 需求文档 vs 工作流文档 vs 检查指南文档）
...
- [指南文档模板文件](./templates/guideline.template) - 指南文档模板（开发规范、配置指南等）
- [需求文档模板文件](../requirements/templates/requirement.template) - 需求文档模板（待办事项、需求分析等）
- [工作流文档模板文件](./templates/workflow.template) - 工作流文档模板（提交前检查、综合深入检查等）
...
1. **新增工作流文档模板**：
   - 创建 `docs/guidelines/templates/workflow.template`
   - 适用于主要工作流文档，如提交前检查、综合深入检查等
