...
| 优先级 | 检查项 | 状态要求 | 时间 |
|--------|--------|----------|------|
| 🚨 **P0 必须** | 代码质量检查 | ✅ 必须通过 | 1-2分钟 |
| 🚨 **P0 必须** | 测试通过 | ✅ 必须通过 | 2-5分钟 |
| 🚨 **P0 必须** | 补全脚本完整性 | ✅ 必须通过 | 1分钟 |
| 🚨 **P0 必须** | 编译通过 | ✅ 必须通过 | 1分钟 |
| 🚨 **P0 必须** | 版本检查* | ✅ 功能变更时必须 | 1分钟 |

| 优先级 | 检查项 | 状态要求 | 建议时间 |
|--------|--------|----------|----------|
| ⚠️ **P1 建议** | 文档更新 | ⚠️ 建议完成 | 5-10分钟 |
| ⚠️ **P1 建议** | CLI 命令注册 | ⚠️ 建议完成 | 2-5分钟 |
| ⚠️ **P1 建议** | 基本测试用例 | ⚠️ 建议完成 | 5-15分钟 |

| 优先级 | 检查项 | 状态要求 | 可选时间 |
|--------|--------|----------|----------|
| 💡 **P2 可选** | 代码优化 | 💡 可选完成 | 15-30分钟 |
| 💡 **P2 可选** | 测试覆盖率提升 | 💡 可选完成 | 10-30分钟 |
| 💡 **P2 可选** | 性能优化 | 💡 可选完成 | 15-60分钟 |
