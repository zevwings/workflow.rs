...
> 本文档整合所有检查指南，提供系统化的综合深入检查方法，用于功能完成后、定期全面审查和重大重构前的全面检查。
>
> **相关指南**：
> - [提交前检查指南](./PRE_COMMIT_GUIDELINES.md) - 快速检查清单，用于日常提交前验证（5-15分钟）
...
1. **全面质量评估**：对所有代码、测试、文档、CLI 进行系统化检查
2. **问题识别**：识别代码重复、测试缺失、文档不完整、CLI 不一致等问题
3. **改进建议**：提供具体的改进方案和优先级排序
4. **跨领域分析**：识别跨领域的问题关联和优化机会

### 检查范围

- **代码质量**：重复代码、工具复用、依赖优化
- **测试覆盖**：测试覆盖情况、测试合理性、缺失测试
- **文档完整性**：README.md、架构文档、CHANGELOG.md
- **CLI 一致性**：命令结构、补全脚本、参数复用

### 检查时间估算

- **完整检查**：2-4 小时（所有领域）
- **重点领域检查**：1-2 小时（选择 2-3 个重点领域）
- **单个领域检查**：30 分钟-1 小时（使用对应的专门指南）
...
**指南**：[CLI 检查指南](./reviews/REVIEW_CLI_GUIDELINES.md)
...
**指南**：[代码检查指南](./reviews/REVIEW_CODE_GUIDELINES.md)
...
**指南**：[测试用例检查指南](./reviews/REVIEW_TEST_CASE_GUIDELINES.md)
...
**指南**：[文档检查指南](./reviews/REVIEW_DOCUMENT_GUIDELINES.md)
...
- [CLI 检查指南](./reviews/REVIEW_CLI_GUIDELINES.md)
- [代码检查指南](./reviews/REVIEW_CODE_GUIDELINES.md)
- [测试用例检查指南](./reviews/REVIEW_TEST_CASE_GUIDELINES.md)
- [文档检查指南](./reviews/REVIEW_DOCUMENT_GUIDELINES.md)
