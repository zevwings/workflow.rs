...
> **📌 注意**：部分功能模块已迁移到分类 TODO 文档，详情请查看：
> - **JIRA 模块** → [`JIRA_TODO.md`](./JIRA_TODO.md)
> - **Git 工作流** → [`GIT_TODO.md`](./GIT_TODO.md)
> - **工作流自动化** → [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)
> - **配置管理** → [`CONFIG_TODO.md`](./CONFIG_TODO.md)
> - **性能优化** → [`PERFORMANCE_TODO.md`](./PERFORMANCE_TODO.md)
>
> 本文档保留完整的功能描述和详细实现建议，分类文档提供更聚焦的待办事项清单。
...
> **✅ 已迁移**：详细待办事项请查看 [`JIRA_TODO.md`](./JIRA_TODO.md)
...
- ❌ `jira assign` - 分配 ticket（API 已实现，待封装为命令）→ **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
- ❌ `jira comment` - 添加评论（API 已实现，待封装为命令）→ **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
- ❌ `jira create` - 创建 ticket → **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
- ❌ `jira update` - 更新 ticket 字段
- ❌ `jira search` - JQL 搜索
- ❌ `jira list` - 列出 tickets → **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
- ❌ `jira watch` - 关注/取消关注 → **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
- ❌ `jira link` - 关联 tickets
- ❌ `jira worklog` - 工作时间记录
- ❌ `jira sprint` - Sprint 相关操作

#### JIRA 集成增强
- ❌ 批量操作（批量更新状态、批量分配）→ **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
- ❌ 自定义工作流规则（配置文件）→ **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
- ❌ 多种触发条件（PR 创建、合并、关闭等）→ **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
- ❌ 自定义评论模板 → **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
...
> **✅ 已迁移**：详细待办事项请查看 [`GIT_TODO.md`](./GIT_TODO.md)

#### 分支管理增强
- ❌ `branch create` - 创建分支（从 JIRA ticket 自动命名）→ **详见** [`GIT_TODO.md`](./GIT_TODO.md)
- ❌ `branch switch` - 快速切换分支（模糊匹配）→ **详见** [`GIT_TODO.md`](./GIT_TODO.md)
- ❌ `branch rename` - 重命名分支 → **详见** [`GIT_TODO.md`](./GIT_TODO.md)
- ❌ `branch compare` - 对比分支差异 → **详见** [`GIT_TODO.md`](./GIT_TODO.md)
- ❌ `branch sync` - 同步分支（fetch + merge/rebase）→ **详见** [`GIT_TODO.md`](./GIT_TODO.md)

#### Commit 管理
- ❌ `commit amend` - 修改最后一次 commit → **详见** [`GIT_TODO.md`](./GIT_TODO.md)
- ❌ `commit squash` - 压缩多个 commits → **详见** [`GIT_TODO.md`](./GIT_TODO.md)
- ❌ `commit reword` - 修改 commit 消息 → **详见** [`GIT_TODO.md`](./GIT_TODO.md)
- ❌ `commit history` - 查看 commit 历史（过滤）→ **详见** [`GIT_TODO.md`](./GIT_TODO.md)

#### Stash 管理
- ❌ `stash list` - 列出所有 stash → **详见** [`GIT_TODO.md`](./GIT_TODO.md)
- ❌ `stash apply` - 应用 stash → **详见** [`GIT_TODO.md`](./GIT_TODO.md)
- ❌ `stash drop` - 删除 stash → **详见** [`GIT_TODO.md`](./GIT_TODO.md)
- ❌ `stash pop` - 应用并删除 stash → **详见** [`GIT_TODO.md`](./GIT_TODO.md)

### 工作流自动化

> **✅ 已迁移**：详细待办事项请查看 [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)

#### 模板系统
- ❌ PR 模板（根据 JIRA ticket 自动生成）→ **详见** [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)
- ❌ Commit 模板（标准化格式）→ **详见** [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)
- ❌ 分支命名模板（根据 JIRA ticket 自动生成）→ **详见** [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)

#### 钩子系统
- ❌ Pre-commit hooks（提交前检查）→ **详见** [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)
- ❌ Post-merge hooks（合并后自动操作）→ **详见** [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)
- ❌ Pre-push hooks（推送前检查）→ **详见** [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)
...
> **✅ 已迁移**：详细待办事项请查看 [`CONFIG_TODO.md`](./CONFIG_TODO.md)

- ❌ `config validate` - 配置文件验证 → **详见** [`CONFIG_TODO.md`](./CONFIG_TODO.md)
- ❌ `config export/import` - 配置导入/导出 → **详见** [`CONFIG_TODO.md`](./CONFIG_TODO.md)
- ❌ 多环境支持（开发/测试/生产）→ **详见** [`CONFIG_TODO.md`](./CONFIG_TODO.md)
...
> **✅ 已迁移**：详细待办事项请查看 [`PERFORMANCE_TODO.md`](./PERFORMANCE_TODO.md)

#### 缓存机制
- ❌ API 响应缓存（减少重复请求）→ **详见** [`PERFORMANCE_TODO.md`](./PERFORMANCE_TODO.md)
- ❌ 本地数据缓存（缓存 tickets/PRs 信息）→ **详见** [`PERFORMANCE_TODO.md`](./PERFORMANCE_TODO.md)
- ❌ 智能刷新（按需刷新缓存）→ **详见** [`PERFORMANCE_TODO.md`](./PERFORMANCE_TODO.md)

#### 并发处理
- ❌ 并行下载（并行下载多个附件）→ **详见** [`PERFORMANCE_TODO.md`](./PERFORMANCE_TODO.md)
- ❌ 批量 API 调用（合并多个 API 请求）→ **详见** [`PERFORMANCE_TODO.md`](./PERFORMANCE_TODO.md)
...
> **📋 注意**：部分 JIRA 功能已迁移到 [`JIRA_TODO.md`](./JIRA_TODO.md)，本文档保留完整的实现建议和详细说明。
>
...
> **📋 注意**：Git 工作流功能已迁移到 [`GIT_TODO.md`](./GIT_TODO.md)，本文档保留完整的实现建议和详细说明。
>
...
> **📋 注意**：工作流自动化功能已迁移到 [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)，本文档保留完整的实现建议和详细说明。
...
> **📋 注意**：配置管理功能已迁移到 [`CONFIG_TODO.md`](./CONFIG_TODO.md)，本文档保留完整的实现建议和详细说明。
...
> **📋 注意**：性能优化功能已迁移到 [`PERFORMANCE_TODO.md`](./PERFORMANCE_TODO.md)，本文档保留完整的实现建议和详细说明。
...
1. **JIRA 命令封装**（已有 API，封装即可）→ **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
   - `jira transition` - 状态转换（API 已实现，待封装为命令）
   - `jira assign` - 分配 ticket（API 已实现，待封装为命令）
   - `jira comment` - 添加评论（API 已实现，待封装为命令）

2. **JIRA info 增强** → **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
...
1. **JIRA 搜索和列表** → **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
   - `jira search` - JQL 搜索
   - `jira list` - 列出 tickets

2. **分支管理增强** → **详见** [`GIT_TODO.md`](./GIT_TODO.md)
   - `branch create` - 创建分支
   - `branch switch` - 快速切换
   - `branch compare` - 对比分支

3. **工作流自动化** → **详见** [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)
   - PR 模板系统
   - Commit 模板
   - Git hooks 集成
...
> **📋 注意**：详细实施计划请查看各分类 TODO 文档。

1. **第一阶段**：封装已有 API 为命令
   - JIRA transition、assign、comment → **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
   - PR info 增强
   - 日志分析基础功能

2. **第二阶段**：增强现有功能
   - JIRA info 显示更多字段 → **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
   - PR review 完整功能
   - 分支管理增强 → **详见** [`GIT_TODO.md`](./GIT_TODO.md)

3. **第三阶段**：工作流自动化
   - 模板系统 → **详见** [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)
   - Git hooks → **详见** [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)
   - 批量操作 → **详见** [`JIRA_TODO.md`](./JIRA_TODO.md)
...
### 分类待办事项文档
- [`JIRA_TODO.md`](./JIRA_TODO.md) - JIRA 模块待办事项
- [`GIT_TODO.md`](./GIT_TODO.md) - Git 工作流待办事项
- [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md) - 工作流自动化待办事项
- [`CONFIG_TODO.md`](./CONFIG_TODO.md) - 配置管理待办事项
- [`PERFORMANCE_TODO.md`](./PERFORMANCE_TODO.md) - 性能优化待办事项
...
- **2024-12-19** - 标注和简化已迁移到分类 TODO 文档的内容
  - JIRA 模块 → [`JIRA_TODO.md`](./JIRA_TODO.md)
  - Git 工作流 → [`GIT_TODO.md`](./GIT_TODO.md)
  - 工作流自动化 → [`WORKFLOW_TODO.md`](./WORKFLOW_TODO.md)
  - 配置管理 → [`CONFIG_TODO.md`](./CONFIG_TODO.md)
