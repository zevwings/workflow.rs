...
use crate::{GitHubClientError, HttpError, HttpResponse};
...
impl GitHubResponse {
    ...
    pub fn text(&self) -> Result<&str, GitHubClientError> {
        self.response.text().map_err(|e| GitHubClientError::ApiError(e.to_string()))
    }
