...
impl MockServerManager {
    ...
    /// 获取服务器 URL，`name` 为 "github" 或 "jira"
    ...
    /// 设置错误响应 Mock，`service` 为 "github" 或 "jira"
    ...
    /// 设置超时场景（504）。mockito 1.x 不支持延迟，用 504 模拟
