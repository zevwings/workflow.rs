...
pub fn validate_jira_ticket_format(ticket: &str) -> Result<()> {
    ...
    if ticket.trim().is_empty() {
        color_eyre::eyre::bail!(
            "{}: {}",
            errors::validation_error::VALIDATION_INVALID_JIRA_ID_FORMAT,
            errors::validation_error::VALIDATION_JIRA_ID_EMPTY
        );
    }
    ...
    if !is_valid_format {
        color_eyre::eyre::bail!(
            ...
            errors::validation_error::VALIDATION_INVALID_JIRA_ID_FORMAT,
            ticket,
            errors::validation_error::VALIDATION_JIRA_ID_FORMAT_HELP
        );
    }
