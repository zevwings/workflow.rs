...
use crate::core::http::{HttpClient, MultipartRequestConfig, RequestConfig};
use crate::core::util::file::FileReader;
...
impl JiraIssueApi {
    ...
    pub fn transition_issue(ticket: &str, transition_id: &str) -> Result<()> {
        ...
        let config = RequestConfig::new().body(&body).auth(auth.clone());
