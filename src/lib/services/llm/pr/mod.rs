...
//!
//! ```rust,no_run
//! use workflow::llm::pr::{CreateGenerator, RewordGenerator, SummaryGenerator, FileSummaryGenerator};
//!
...
mod create;
#[path = "create.system.rs"]
mod create_system;
mod file_summary;
#[path = "file_summary.system.rs"]
mod file_summary_system;
mod helpers;
mod reword;
#[path = "reword.system.rs"]
mod reword_system;
#[path = "summarize.system.rs"]
mod summarize_system;
mod summary;
