...
use super::builder::ProgressBarBuilder;
use super::render::start_render_thread;
use super::terminal::{disable_raw_mode, enable_raw_mode, hide_cursor, show_cursor};
...
impl ProgressBar {
    ...
    pub fn with_success(self, message: impl Into<String>) {
        self.stop();
        let theme = crate::core::prompt::style::theme::get_theme();
