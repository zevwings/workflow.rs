...
use crate::services::git::{CommitInfo, GitBranch, GitCommit, GitStash};
...
"#,
        ...
        FileWriter::new(&sequence_editor_script)
            ...
            .wrap_err_with(|| errors::file::FILE_WRITE_SEQUENCE_EDITOR_SCRIPT_FAILED)?;
...
"#,
        ...
        FileWriter::new(&message_editor_script)
            ...
            .wrap_err_with(|| errors::file::FILE_WRITE_MESSAGE_EDITOR_SCRIPT_FAILED)?;
