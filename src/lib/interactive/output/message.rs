...
use crate::interactive::style::{get_theme, Theme};
...
macro_rules! success {
    ($($arg:tt)*) => {
        let _ = $crate::interactive::Message::global().success(&format!($($arg)*));
    };
}
...
macro_rules! error {
    ($($arg:tt)*) => {
        let _ = $crate::interactive::Message::global().error(&format!($($arg)*));
    };
}
...
macro_rules! warning {
    ($($arg:tt)*) => {
        let _ = $crate::interactive::Message::global().warning(&format!($($arg)*));
    };
}
...
macro_rules! info {
    ($($arg:tt)*) => {
        let _ = $crate::interactive::Message::global().info(&format!($($arg)*));
    };
}
...
macro_rules! debug {
    ($($arg:tt)*) => {
        let _ = $crate::interactive::Message::global().debug(&format!($($arg)*));
    };
}
...
macro_rules! br {
    () => {
        let _ = $crate::interactive::Message::global().break_line();
    };
    ($char:expr) => {
        let _ = $crate::interactive::Message::global().separator($char, 80);
    };
    ($char:expr, $length:expr) => {
        let _ = $crate::interactive::Message::global().separator($char, $length);
    };
    ($char:expr, $length:expr, $text:expr) => {
        let _ = $crate::interactive::Message::global_mutex()
            .lock()
            .unwrap()
