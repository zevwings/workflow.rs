...
use crate::interactive::dialog::{PromptError, Result};
use crate::interactive::form::builder::FormBuilder;
use crate::interactive::form::field::{FieldType, FormField};
use crate::interactive::form::group::{FormStep, StepType};
...
impl FormExecutor {
    ...
    fn execute_confirm_field(
        ...
        let mut builder =
            crate::interactive::dialog::ConfirmBuilder::new(&field.prompt).default(default_value);
    ...
    fn execute_input_field(
        ...
        let mut builder = if is_password {
            crate::interactive::dialog::InputBuilder::new(&field.prompt).password()
        } else {
            crate::interactive::dialog::InputBuilder::new(&field.prompt)
        };
    ...
    fn execute_select_field(
        ...
        let mut builder = crate::interactive::dialog::SelectBuilder::new(
            field.prompt.clone(),
            field.options.clone(),
        )
    ...
    fn execute_multiselect_field(
        ...
        let mut builder = crate::interactive::dialog::MultiSelectBuilder::new(
            &field.prompt,
            field.options.clone(),
        )
...
struct ArcValidatorAdapter(std::sync::Arc<dyn crate::interactive::dialog::Validator + Send + Sync>);

impl crate::interactive::dialog::Validator for ArcValidatorAdapter {
