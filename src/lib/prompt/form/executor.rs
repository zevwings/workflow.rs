...
use crate::prompt::dialog::{PromptError, Result};
use crate::prompt::form::builder::FormBuilder;
use crate::prompt::form::field::{FieldType, FormField};
...
impl FormExecutor {
    ...
    fn execute_confirm_field(
        ...
        let mut builder =
            crate::prompt::dialog::ConfirmBuilder::new(&field.prompt).default(default_value);
    ...
    fn execute_input_field(
        ...
        let mut builder = if is_password {
            crate::prompt::dialog::InputBuilder::new(&field.prompt).password()
        } else {
            crate::prompt::dialog::InputBuilder::new(&field.prompt)
        };
    ...
    fn execute_select_field(
        ...
        let mut builder =
            crate::prompt::dialog::SelectBuilder::new(field.prompt.clone(), field.options.clone())
    ...
    fn execute_multiselect_field(
        ...
        let mut builder =
            crate::prompt::dialog::MultiSelectBuilder::new(&field.prompt, field.options.clone())
...
struct ArcValidatorAdapter(std::sync::Arc<dyn crate::prompt::dialog::Validator + Send + Sync>);

impl crate::prompt::dialog::Validator for ArcValidatorAdapter {
