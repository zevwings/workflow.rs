...
pub fn collect_github_account_with_defaults(old_account: &GitHubAccount) -> Result<GitHubAccount> {
    ...
    let email = crate::input!("Please enter your GitHub account email (press Enter to keep)")
    ...
    let api_token = crate::input!("Please enter your GitHub API token (press Enter to keep)")
