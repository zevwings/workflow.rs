...
define HELP_TOOLS
	@echo "工具安装相关："
	@echo "  make setup            - 安装所需的开发工具（rustfmt, clippy, rust-analyzer, cargo-bloat, lychee）"
	@echo ""
endef
...
setup:
	...
	@echo ""
	@echo "安装 lychee（链接检查工具）..."
	@if command -v lychee >/dev/null 2>&1; then \
		echo "lychee 已安装"; \
	else \
		cargo install lychee 2>/dev/null || echo "⚠ lychee 安装失败，可稍后手动运行: cargo install lychee"; \
	fi
	@echo "开发工具安装完成"
	@echo ""
	@echo "=========================================="
