...
/// - 命令类型匹配预期
#[test]
fn test_github_command_with_all_subcommands_parses_successfully() -> Result<()> {
    // Arrange: 准备所有子命令的输入
...
/// - 错误消息明确指示无效子命令
#[test]
fn test_github_command_with_invalid_subcommand_returns_error() -> Result<()> {
    // Arrange: 准备无效子命令的输入
...
/// - 错误消息明确指示缺少子命令
#[test]
fn test_github_command_with_missing_subcommand_returns_error() -> Result<()> {
    // Arrange: 准备缺少子命令的输入
...
/// - 错误消息明确指示不接受额外参数
#[test]
fn test_github_all_commands_with_extra_arguments_return_error() -> Result<()> {
    // Arrange: 准备所有命令和额外参数
...
/// - 错误消息明确指示命令无效
#[test]
fn test_github_command_with_uppercase_subcommand_returns_error() -> Result<()> {
