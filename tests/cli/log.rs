...
/// - 所有子命令都可以正确解析
#[test]
fn test_log_command_with_all_subcommands_parses_successfully_return_true() -> Result<()> {
    // Arrange: 准备所有子命令的输入
...
#[test]
fn test_log_jira_id_parameter_is_optional_in_all_commands_return_collect() -> Result<()> {
