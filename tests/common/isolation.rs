...
impl TestIsolation {
    ...
    pub fn new() -> Result<Self> {
        ...
        let work_dir_guard = CurrentDirGuard::new(temp_dir.path())?;
...
mod tests {
    ...
    fn test_test_isolation_basic() -> Result<()> {
        ...
        // 验证当前目录已切换
        assert_eq!(std::env::current_dir()?, work_dir);
